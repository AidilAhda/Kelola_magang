<h3 class='page-header'>Daftar Magang </h3>
...
?>
<div class='table-resfponsive' style="width: 1700px;">
    <?php
    if (isset($_GET['id_siswa'])) {
        ...
        $q = "SELECT du.id_user,du.nis_user,du.name_user,b.namaBidang,du.sklh_user FROM `detail_user` AS du INNER JOIN bidang as b ON b.idBidang = du.idBidang";
                ...
                if ($r->num_rows !== 0) {
                    ...
                    while ($get_siswa = $query_siswa->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <td><a href='siswa&id_siswa=$id_siswa' title='Edit $name' class='btn btn-success'
                    ><i class='fa-solid fa-pen-to-square'></i> Edit info</a> 
                    <a style='cursor:pointer' class='btn btn-danger' onclick='hapusSiswa($id_siswa)'><i class='fa-solid fa-trash'></i> Hapus Siswa</a></td>
                            </tr>";
                    }
                    // $conn->close();
                    echo "</tbody></table>";
