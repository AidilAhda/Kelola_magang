<h3 class="page-header">Tambah Magang </h3>
<?php
if (isset($_GET['st'])) {
  if ($_GET['st'] == 1) {
...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" name="nis" placeholder="Masukan ID" required>
    </div>
  </div>
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="name">Bidang:</label>
    <div class="col-sm-10">
      <select name="bidang" id="bidang">
        ...
        while ($b = mysqli_fetch_array($bidang)) {
          echo "<option value = '$b[idBidang]'>$b[namaBidang]</option>";
        }
        ?>
      </select>
    </div>
  ...
  <div class="form-group">
    <fieldset>
      ...
      <div class="col-sm-10">
        <input type="password" class="form-control" name="pwd" placeholder="Masukan Password" id="password" required>
      </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2"></label>
    <div class="col-sm-10">
      <input type="password" class="form-control" name="pwd_cek" placeholder="Ulangi Password" id="confirm_password" required>
    </div>
    </fieldset>
  </div>
  <div class="form-group">
