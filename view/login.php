...
<body>
  ...
  <div class="container">
    <form class=" form-signin" method="post" action="model/proses.php">
      <h2 class="form-signin-heading" style="color: red; font-weight:bold;">Selamat Datang</h2>
...
<style>
  body {
    background: url(http://localhost/Kelola_magang/assets/gambar-login.jpeg) no-repeat;
