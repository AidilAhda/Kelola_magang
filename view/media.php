...
<head>
  ...
  <title>Pengelolaan Data Magang</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar" style="background-color: red; color:white">
        <img class="gambar" src="http://localhost/Kelola_magang/assets/logo-indihome.png" alt="">
