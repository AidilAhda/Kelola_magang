...
} elseif (strcmp($page, "add_nilai") == 0) {
  if (!isset($_SESSION['pb'])) {
    header("location:home");
  } else {
    include './view/adm/add_nilai.php';
  }
} elseif (strcmp($page, "lihatBidang") == 0) {
  if (!isset($_SESSION['pb'])) {
    header("location:home");
  } else {
    include './view/adm/lihatBidang.php';
  }
} elseif (strcmp($page, "lihat_nilai") == 0) {
  if (!isset($_SESSION['sw'])) {
    header("location:home");
  } else {
    include './view/lihat_nilai.php';
  }
} elseif (strcmp($page, "cetak_kartu") == 0) {
  if (!isset($_SESSION['sw'])) {
    header("location:home");
  } else {
