...
(49, 9, 10, 2, 18, 'catatan pertama\r\n', 'Dikonfirmasi'),
(54, 13, 10, 6, 29, 'test laporan', 'Dikonfirmasi'),
(52, 9, 10, 4, 20, 'laporan hari ini', 'Menunggu'),
(53, 10, 10, 6, 29, 'test', 'Dikonfirmasi'),
(55, 10, 10, 1, 31, 'laporan day 1', '');
...
(66, '9', 10, 2, 18, '23.07 WIB', 'Dikonfirmasi', '23.07 WIB', 'Dikonfirmasi'),
(67, '10', 10, 2, 18, '23.09 WIB', 'Ditolak', '', 'Belum Absen'),
(68, '12', 10, 4, 20, '14.28 WIB', 'Dikonfirmasi', '', 'Belum Absen'),
(69, '9', 10, 4, 20, '18.24 WIB', 'Ditolak', '', 'Belum Absen'),
(70, '13', 10, 6, 29, '18.26 WIB', 'Dikonfirmasi', '18.26 WIB', 'Dikonfirmasi'),
(71, '10', 10, 1, 31, '15.04 WIB', 'Menunggu', '', 'Belum Absen'),
(72, '14', 11, 4, 3, '16.45 WIB', 'Ditolak', '', 'Belum Absen');
...
INSERT INTO `detail_user` (`id_user`, `nis_user`, `name_user`, `idBidang`, `sklh_user`, `jk_user`) VALUES
(11, 221, 'user2', 2, 'UIN SUSKA RIAU', 'L'),
(10, 1232, 'user11', 2, 'UIN SUSKA RIAU', 'L'),
(12, 222, 'test', 2, 'UIN SUSKA RIAU', 'L'),
(13, 876, 'userT', 1, 'UIN SUSKA RIAU', 'L'),
(14, 789, 'Evo', 1, 'UIN SUSKA RIAU', 'L');
...
CREATE TABLE `tbl_nilai` (
  `nama_peserta` varchar(255) CHARACTER SET latin1 NOT NULL,
  `kepribadian` int(3) NOT NULL,
  `kedisiplinan` int(3) NOT NULL,
  `keterampilan` int(3) NOT NULL,
  `kerja_sama` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_nilai` (`nama_peserta`, `kepribadian`, `kedisiplinan`, `keterampilan`, `kerja_sama`) VALUES
('user1', 77, 88, 99, 66),
('user2', 11, 22, 33, 44);
...
(7, 'admin1@gmail.com', 'b480c074d6b75947c02681f31c90c668c46bf6b8', 'pb'),
(12, 'test@gmail.com', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 'sw'),
(10, 'user11@gmail.com', '3d5cbfed48ce23d2f0dc0a0baa3ec2ee93867b2b', 'sw'),
(13, 'userT@gmail.com', '355cfdd573a6c58dbe9ede4f2dfd9b1ae688b91c', 'sw'),
(11, 'user2@gmail.com', 'a1881c06eec96db9901c7bbfe41c42a3f08e9cb4', 'sw'),
(14, 'evodia@magang.com', '261679fd18ad73433144fdf8bececf5b99851ace', 'sw');
...
--
ALTER TABLE `catatan`
  MODIFY `id_cat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
